...
from .nmpc_backend import NMPCBackendSolveResult, NMPCSolveRequest, ProcessCasadiNMPCBackend
...
class SwarmRuntime:
    ...
    def _build_nmpc_controllers(self) -> Dict[int, CasadiNMPCController]:
        return {
    ...
    def _build_process_nmpc_backend(self) -> ProcessCasadiNMPCBackend:
        return ProcessCasadiNMPCBackend(
            self.config,
            horizon_steps=self.horizon_steps,
            dt=self.dt,
            max_neighbors=self.max_neighbors,
